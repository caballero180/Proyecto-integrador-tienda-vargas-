...
public class ControladorCategoria implements MouseListener{
    ...
    public ControladorCategoria(visatAltas altasvista,
        ...
        this.consultavista.consultaCat.addMouseListener(this);
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if (e.getSource().equals(this.consultavista.consultaCat)){  
            this.Categoria.Consultacat(consultavista, this.consultavista.referenciaCat.getText().toUpperCase());
        }
